...
*/
ExtGLWidget::ExtGLWidget( QWidget* parent, const QOpenGLWidget* /* shareWidget*/ ):
...
void ExtGLWidget::mouseMoveEvent( QMouseEvent* e )
{
    if ( true == in_move )
    {
        ...
        double rely = diff.y() * accel / h;

        double new_xshift = xViewportShift() + relx;
        double new_yshift = yViewportShift() - rely;
...
void ExtGLWidget::mouseDoubleClickEvent( QMouseEvent* event )
{
