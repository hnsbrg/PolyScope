...
ColorLegend::ColorLegend()
{
    ...
    axis_.setNumberFont( QFont( "Helvetica", 8 ) );
...
void ColorLegend::setNumberFont( QString const& family, int pointSize, int weight, bool italic )
{
    axis_.setNumberFont( family, pointSize, weight, italic );
}
