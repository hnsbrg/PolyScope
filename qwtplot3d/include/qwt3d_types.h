...
const int INVALID_CHAIN_INDEX = INT_MIN;
...
public:
    ...
    Atom( int i, Triple p, double r, Qwt3D::RGBA c = Qwt3D::RGBA(), int monomerType = -1, int chainIndex = INVALID_CHAIN_INDEX ) { index = i;  pos = p; radius = r; col = c; monomer_type = monomerType; chain_index = chainIndex; }
};
...
public:
    ...
    Bond( int i,  Triple t1, Triple t2, Qwt3D::RGBA c = Qwt3D::RGBA() ) { index = i; first = t1; second = t2; col = c;}
};
typedef std::vector<Bond> BondVector;
typedef std::vector<Atom> AtomVector;

QWT3D_EXPORT Qwt3D::ParallelEpiped hull( AtomVector const& data );
