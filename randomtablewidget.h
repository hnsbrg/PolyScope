#ifndef RANDOMTABLEWIDGET_H
#define RANDOMTABLEWIDGET_H
...
class RandomTableWidget : public SequenceTableWidget
{
    Q_OBJECT

public:
    RandomTableWidget( QWidget* parent = 0 );
