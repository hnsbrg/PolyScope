#ifndef DEFINEDTABLEWIDGET_H
#define DEFINEDTABLEWIDGET_H
...
class DefinedTableWidget : public SequenceTableWidget
{
    Q_OBJECT
public:
    DefinedTableWidget( QWidget* parent = 0 );
